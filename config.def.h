...
static const char *fonts[]          = {"Hack Nerd Font Mono:style=bold:size=13" };
...
static const char *volupcmd[]  = { "amixer", "set Master 5%+" };
static const char *voldowncmd[]  = { "amixer", "set Master 5%-"  };
